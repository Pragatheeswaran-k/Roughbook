...
type ExpenseFormProps = {
  ...
  type="datetime-local"
  value={form.date}
  onChange={(v) => setForm((f: ExpenseFormValues) => ({ ...f, date: v }))}
...
/>
          ...
          <FormSelect
            label="Type"
            value={form.type}
            onChange={(v: string) => setForm((f: ExpenseFormValues) => ({ ...f, type: v }))}
            options={types}
          ...
          <FormSelect
            label="Category"
            value={form.category}
            onChange={(v: string) => setForm((f: ExpenseFormValues) => ({ ...f, category: v }))}
            options={categories}
          ...
          <FormField
            ...
            placeholder="Ex: 250"
            value={form.amount}
            onChange={(v) => setForm((f: ExpenseFormValues) => ({ ...f, amount: v }))}
          ...
          <FormSelect
            ...
            onChange={(v: string) => setForm((f: ExpenseFormValues) => ({ ...f, paymentMode: v }))}
          ...
          <FormField
            ...
            value={form.tags}
            onChange={(v) => setForm((f: ExpenseFormValues) => ({ ...f, tags: v }))}
          ...
          <FormField
            ...
            value={form.note}
            onChange={(v) => setForm((f: ExpenseFormValues) => ({ ...f, note: v }))}
            disabled={adding}
          />
        </div>
